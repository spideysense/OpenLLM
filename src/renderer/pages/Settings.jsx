        ...
        {tabs.map(t => (
          <button
            ...
            style={{
              ...
              color: section === t.id ? 'var(--earth)' : 'var(--text-light)',
              borderBottom: section === t.id ? '2px solid var(--pipe-yellow)' : '2px solid transparent',
              marginBottom: -2, borderRadius: 0, fontFamily: 'var(--font-display)',
            }}
          >
            {t.label}
          </button>
