...
- Privacy: local inference and memory run on the household device. Paired clients exchange encrypted requests with it. Web tools, connectors, published artifacts and optional Cloud Boost disclose information to the requested destination. Users can view, edit, delete and back up their local memory. Never claim that all data always stays on one device.
